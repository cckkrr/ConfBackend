...
func GenDistanceCacheKey(packetId, nodeId string) string {
	return com.DistanceCachePrefix + ":" + com.PacketPrefix + packetId + ":" + com.NodePrefix + nodeId
}

func GenDistanceQueryKey(packetId string) string {
	return com.DistanceCachePrefix + ":" + com.PacketPrefix + packetId + ":" + com.NodePrefix + "*"
}

func GenPacketTimelogPrefix() string {
	return com.DistanceCachePrefix + ":" + com.PacketTimelogPrefix
}
...
func GenLatestUpdatePackageTimeKey() string {
	return com.DistanceCachePrefix + ":" + com.LatestPackageTimePrefix
}
